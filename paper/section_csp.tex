...
25 solved instances against 27. It buys a $93\%$ success rate at $0.03\%$ of the search cost, by
carrying one complete (initially infeasible) assignment forward and repairing it, rather than
rebuilding a partial assignment prefix on every backtrack.
...
Table~\ref{tab:csp-solved} is therefore not a pruning result at all: it is $10.2\times$ lower
throughput measured against a shared stopwatch. Under censoring the sign of the metric's meaning
