...
\paragraph{The theory's step-size requirement is visible.} The polynomial schedule
$\alpha_n = (1+n)^{-p}$ converges and a constant $\alpha$ does not: constant $\alpha = 0.1$ and
$\alpha = 0.5$ give $24.52\%$ and $21.80\%$ regret against $12.60\%$ for the baseline schedule.
...
\centering
\small
\caption{$Q$-learning hyperparameter sweep. 13 configurations $\times$ 3 seeds at
